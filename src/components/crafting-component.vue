        ...
        <table class="table-bordered" id="maintab">
          ...
          <tbody>
            <tr v-for="(tableRows, index) in tableRows" :key="index">
              ...
              <td> <input type="text" class="form-control" :id="`unitCost-${index}`" @input="computePCost(index)"
              ...
              <td> <input type="text" class="form-control" :ref="`totalP-${index}`" :id="`totalP-${index}`"
                  v-model="craftpcost[index]" :data=computeCraftingMats(index) :name="`totalP-${index}`"></td>
              ...
              <td> <input type="text" class="form-control" :id="`mu-${index}`" @input="computePCost(index)"
      ...
      <div class="row padTop" id="lastRowPad">
          ...
          <table class="table-bordered">
            ...
            <tbody>
              ...
              <tr id="lastLaborRow">
                ...
                <td></td>
                <td></td>
                <td id="totalLaborCost"><strong>TOTAL LABOR COST:  </strong></td>
        ...
        <div class="col" id="lastRegion">
          ...
          <div class="row" id="lastFormRow">
            <div class="col mb-3">
              <label for="exampleInputEmail1" class="form-label">SOLD TO</label>
